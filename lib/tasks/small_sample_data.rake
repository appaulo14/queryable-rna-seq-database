...
#     random_sample_names.each do |rsn|
...
#   #Create differnetial expresssion tests with random values for the transcripts
#   Transcript.all.each do |t|
...
#   #Create 1000 transcript/go term associations with random values
#   1000.times do |n|
