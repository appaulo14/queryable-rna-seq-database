namespace :generate_test_files do
  ...
  def make_transcript_samples(samples_needed)
    @transcript_samples = []
  ...
  def make_gene_samples(samples_needed)
    @gene_samples = []
